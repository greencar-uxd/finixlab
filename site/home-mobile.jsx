        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ margin: '16px 0 0', fontSize: 13, lineHeight: 1.8, color: FNX.sage }}>
            {t({
              ...
              ja: '一つの肌哲学から生まれた二つのブランド。「回復力」という同じ根から、毎日のスローエイジングケアと、専門家向けのリカバリーケアへ枝分かれします。',
            })}
          </p>
        </div>
          ...
          {brands.map((b) => (
            <article key={b.name}>
              ...
              <div style={{ marginTop: 20 }}>
                <Btn kind="ghost" full size="md" style={{ color: FNX.pineInk, borderColor: FNX.pineInk }} data-go={b.go}>{t({ en: 'View', ko: '보기', ja: '見る' })} {b.name} →</Btn>
              </div>
            </article>
          ))}
        </div>
